  ...
  return (
    <div className="max-w-[800px] mx-auto">
      ...
      <div className="flex flex-col gap-3">
        {items.map((item) => (
          ...
          >
            ...
            <span className="text-sm text-gray-800 font-semibold min-w-[70px] text-right">
      ...
      <div className="flex items-center justify-end gap-6 mt-5 pb-5">
        ...
        <button
          className="px-8 py-3 text-base font-semibold bg-primary text-white border-0 rounded-lg cursor-pointer"
          type="button"
